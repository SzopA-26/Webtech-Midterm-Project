            ...
            <div class="modal-content">
                <div class="container">
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-outline-danger border-left-0 border" type="submit"
                    ...
                    <div class="container">
                        ...
                        <div class="input-group">
                            ...
                            <input type="c-password" class="form-control " id="c-password"
                                placeholder="Confirm password" name="c-password">
                        </div>
                        <br>
                        <div>
                            <input id="datepicker" width="276" placeholder="Date of birth">
                            <script>
